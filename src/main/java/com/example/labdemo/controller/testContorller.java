...
/*    @GetMapping("/user/control")
    ...
    return new ModelAndView("user_active");
    }
    @GetMapping("/user/now")
    public ModelAndView userNow(){
        return new ModelAndView("user_now");
    }
    @GetMapping("/user/sale")
    public ModelAndView userSale(){
        return new ModelAndView("user_sale");
    }
    @GetMapping("/saleNote/product")
    public ModelAndView saleNoteProduct(){
        return new ModelAndView("sale_note_product");
    }
    @GetMapping("/saleNote/client")
    public ModelAndView saleNoteClient(){
        return new ModelAndView("sale_note_client");
    }
    @GetMapping("/saleNote/receive")
    public ModelAndView saleNoteReceive(){
        return new ModelAndView("sale_note_receive");
    }
    @GetMapping("/company")
